  ...
  return (
    <div ref={ref} className="w-full">
      <button
        ...
        className="inline-flex w-full items-center rounded-lg border border-gray-400 px-4 py-2 text-center text-base font-medium focus:outline-none dark:border-gray-600 dark:bg-gray-700"
        type="button"
      >
